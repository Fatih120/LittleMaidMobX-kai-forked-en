...
public class EntityAIAttackOnCollide extends EntityAIBase implements IEntityAI {
	...
	public EntityAIAttackOnCollide(EntityLittleMaid par1EntityLittleMaid, float par2, boolean par3) {
