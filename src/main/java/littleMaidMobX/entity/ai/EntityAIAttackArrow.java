...
public class EntityAIAttackArrow extends EntityAIBase implements IEntityAI {
	...
	public EntityAIAttackArrow(EntityLittleMaid pEntityLittleMaid) {
	...
	{
		return (IEntityLittleMaidAvatarBase)fAvatar;
	}
