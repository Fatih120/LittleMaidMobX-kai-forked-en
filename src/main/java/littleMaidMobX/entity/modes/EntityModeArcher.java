...
public class EntityModeArcher extends EntityModeBase {
	...
	public EntityModeArcher(EntityLittleMaid pEntity) {
		super(pEntity);
	}
...
//		ltasks[1].addTask(2, new EntityAIOwnerHurtTarget(owner));
		ltasks[1].addTask(3, new EntityAIHurtByTarget(owner, true));
		ltasks[1].addTask(4, new EntityAINearestAttackableTarget(owner, EntityLivingBase.class, 0, true));
		...
		ltasks2[1].addTask(1, new EntityAIHurtByTarget(owner, true));
		ltasks2[1].addTask(2, new EntityAINearestAttackableTarget(owner, EntityLivingBase.class, 0, true));
	...
	public boolean checkItemStack(ItemStack pItemStack) {
		...
		return (pItemStack.getItem() instanceof ItemBow) || (pItemStack.getItem() == Items.arrow) 
				|| TriggerSelect.checkItem(ls, "Bow", pItemStack) || TriggerSelect.checkItem(ls, "Arrow", pItemStack);
	}
