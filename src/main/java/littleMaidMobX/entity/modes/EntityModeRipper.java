...
public class EntityModeRipper extends EntityModeBase {
	...
	public EntityModeRipper(EntityLittleMaid pEntity) {
		super(pEntity);
		timeSinceIgnited = -1;
	}
...
//		ltasks[0].addTask(11, new EntityAILeapAtTarget(pentitylittlemaid, 0.3F));
		...
		ltasks[1].addTask(1, new EntityAINearestAttackableTarget(owner, EntityCreeper.class, 0, true));
		ltasks[1].addTask(2, new EntityAINearestAttackableTarget(owner, EntityTNTPrimed.class, 0, true));
		ltasks[1].addTask(3, new EntityAINearestAttackableTarget(owner, EntitySheep.class, 0, true));
		...
		ltasks2[1].addTask(1, new EntityAINearestAttackableTarget(owner, EntityCreeper.class, 0, true));
		ltasks2[1].addTask(2, new EntityAINearestAttackableTarget(owner, EntityTNTPrimed.class, 0, true));
		...
		ltasks3[1].addTask(1, new EntityAINearestAttackableTarget(owner, EntityLivingBase.class, 0, true));
